...
<body>
    <div id="app">
        <div id="main-content">
            <?php echo $__env->make('components.app-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="section-one">
                <div class="seco-wrap row">
                    ...
                    <div class="seco-r col">
                        <?php echo $__env->make('components.Editor-illustration', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\onez.ph.dev\resources\views/layouts/app.blade.php ENDPATH**/ ?>